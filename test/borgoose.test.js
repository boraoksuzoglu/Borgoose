    ...
    describe('Data Management', () => {
        ...
        describe("Find", () => {
            ...
            test('Should find multiple data.', () => {
                ...
                expect(multiple_data).toEqual([{id: 1, name: "bora", age: 19}, {id: 2, name: "burak", age: 19}])
            })
        ...
        describe("Update", () => {
            ...
            test('Should update a single data.', () => {
                ...
                expect(getJSON()).toEqual([{id: 1, name: "bora", age: 20}, {id: 2, name: "burak", age: 19}, {id: 3, name: "baris", age: 26}, {id: 4, name: "sebnem", age: 50}])
            })
            ...
            test('Should update multiple data.', () => {
                ...
                expect(getJSON()).toEqual([{id: 1, name: "bora", age: 5}, {id: 2, name: "burak", age: 5}, {id: 3, name: "baris", age: 5}, {id: 4, name: "sebnem", age: 5}])
            })
        })
        ...
        describe("Delete", () => {
            ...
            test('Should delete multiple data.', () => {
                ...
                expect(getJSON()).toEqual([{id: 3, name: "baris", age: 26}, {id: 4, name: "sebnem", age: 50}])
            })
        })
